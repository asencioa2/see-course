    ...
    return (
        <section className="flex">
            <div className="w-2/3 mx-12">
                ...
                <Image src="https://cdn.pixabay.com/photo/2016/11/19/14/00/code-1839406_1280.jpg" alt="" width={1000} height={800} />
            ...
            <div className="w-1/3 mx-12 ">
                ...
                <Announcement title="Website Questionnaire:" desc="After you have taken Exam 2 if you time please take the Questionnaire"/>
            </div>
        </section>
    )
}