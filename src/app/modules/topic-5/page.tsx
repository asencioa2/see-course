    ...
    <div className="flex justify-center">
      <div className="w-4/5">
        ...
        <div className='flex w-full'>
          <div>
          {
            hasWindow && <ReactPlayer className="mr-4" url='https://www.youtube.com/watch?v=z8R7gOcy5I4' width={580}/>
          }
          </div>
          <div>
          {
            hasWindow && <ReactPlayer className="ml-4" url='https://www.youtube.com/watch?v=iyfldFelaSk' width={580}/>
          }
          </div>
        </div> 
